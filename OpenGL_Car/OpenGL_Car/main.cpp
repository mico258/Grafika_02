...
void display1(void)
{
	...
	display_string(180, 540, "Institut Teknologi Bandung", 1); //correct cordinate according to name
	...
	display_string(100, 340, "Mikhael Artur Darmakesuma - 13515099", 2);
	display_string(100, 310, "Bobby Indra Nainggolan - 13515102", 2);
	display_string(100, 280, "Mico - 13515126", 2);
	display_string(250, 150, "PRESS SPACE BAR TO DISPLAY", 2);
	glutPostRedisplay();
	glutSwapBuffers();
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("OpenGL CAR "); /* Open a window with a title. */
